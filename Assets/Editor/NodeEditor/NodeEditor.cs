...
public class NodeEditor : EditorWindow {
		...
		if(e.button == 1 && !makeTransitionMode)
		{
			if(e.type == EventType.MouseDown)
			{
				...
				if(!clickedOnWindow)
				{
					...
					menu.AddItem(new GUIContent("Add location"),false, ContextCallback, "location");
	...
	void ContextCallback(object obj)
	{
		...
		if(clb.Equals("location"))
		{
			CalcNode calcNode = new CalcNode();
			calcNode.windowRect = new Rect(mousePos.x, mousePos.y, 200, 300);
